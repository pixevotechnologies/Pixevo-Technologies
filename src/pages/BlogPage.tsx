          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4 rounded-2xl bg-slate-900/40 border border-slate-800">
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <button
                ...
                disabled={isLoading}
                title={language === 'ar' ? 'إعادة تحميل المقالات' : 'Simulate fetch & reload articles'}
            ...
            {filteredPosts.map((post) => (
              <StaggerItem key={post.id}>
                <div
                  ...
                  className="h-full rounded-2xl bg-slate-900/40 border border-slate-800 p-7 space-y-5 hover:border-slate-700 transition-all duration-300 flex flex-col justify-between group cursor-pointer"
