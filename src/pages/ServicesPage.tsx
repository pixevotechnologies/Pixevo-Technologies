            ...
            return (
              <StaggerItem key={service.id}>
                <div
                  ...
                  className="h-full rounded-2xl bg-slate-900/40 border border-slate-800 p-7 sm:p-8 space-y-6 hover:border-slate-700 transition-all duration-300 flex flex-col justify-between"
                >
