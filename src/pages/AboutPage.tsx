      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ScrollReveal direction="up" delay={50}>
            <div className="h-full p-8 sm:p-10 rounded-2xl bg-slate-900/40 border border-slate-800 space-y-4 shadow-xl">
            ...
            {data.coreValues.map((val) => {
              ...
              return (
                <StaggerItem key={val.name}>
                  <div className="h-full p-6 rounded-2xl bg-slate-900/40 border border-slate-800 hover:border-slate-700 space-y-3 transition-all">
